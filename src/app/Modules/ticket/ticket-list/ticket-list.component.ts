...
export class TicketListComponent implements OnInit {
  ...
  constructor(private router: Router, private _route: ActivatedRoute) {
    ...
    this.cars = [
      {date:'01-02-2020', title:'Kit Not Working', created_by:'Sanjay', status:'Open',last_update:'01-02-2020'},
      {date:'07-02-2020', title:'User Manual Missing', created_by:'Krish', status:'Open',last_update:'07-02-2020'},
      {date:'02-02-2020', title:'Missing Components', created_by:'Arjun', status:'Pending',last_update:'02-02-2020'},
      {date:'04-02-2020', title:'Want to Return', created_by:'Darma', status:'Open',last_update:'04-02-2020'},
      {date:'05-02-2020', title:'Need an Exchange', created_by:'Nikil', status:'Pending',last_update:'05-02-2020'},
      {date:'06-02-2020', title:'Unable to Use', created_by:'Sahadev', status:'Open',last_update:'06-02-2020'},
      {date:'08-02-2020', title:'Kit Not Working', created_by:'Vyas', status:'Open',last_update:'08-02-2020'},
      {date:'09-02-2020', title:'Damaged Kit Received', created_by:'Ganesh', status:'Closed',last_update:'09-02-2020'},
      ...
      {date:'03-02-2020', title:'Damaged Kit Received', created_by:'Drupad', status:'Open',last_update:'03-02-2020'},
